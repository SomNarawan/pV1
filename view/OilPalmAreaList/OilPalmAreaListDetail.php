        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form class="form-signin" method="POST" action='addData.php'>
                    ...
                    <input type="hidden" id="id" name="id" value="<?php echo "".$LOGFARMIDPALM[1]['FirstName']."" ?>">
                    <input type="hidden" id="fname" name="fname" value="<?php echo "".$LOGFARMIDPALM[1]['Alias']."" ?>">
                    <input type="hidden" id="logid" name="logid" value="<?php echo "".$LOGFARMIDPALM[1]['ID'].""?>">
