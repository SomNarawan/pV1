...
<div class="container">
    ...
    <div class="row">
        ...
        creatCard( "card-color-two",   "พื้นที่ทั้งหมด", getAreaRai()." ไร่", "dashboard" );
        creatCard( "card-color-three", "จำนวนต้น",  getNumTree()." ต้น", "format_size" );
    ?>
        <div class="col-xl-3 col-12 mb-4">
            <div class="card border-left-primary card-color-four shadow h-100 py-2" data-toggle="modal"
                data-target="#modal-1" style="cursor:pointer;">
                <div class="card-body">
