...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog">
    <form  method="post" enctype="multipart/form-data" id="form-insert" action="manage.php">
                    ...
                    <div class="main">
                                ...
                                <div class='form-group'>
                                    <div class='form-line'>
                                        <input type='text' id='name_insert' name='name_insert' class='form-control' 
                                            placeholder="ชื่อแมลง" required="" oninput="setCustomValidity('')">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class='form-group'>
                                    <div class='form-line'>
                                        <input type='text' id='alias_insert' name='alias_insert' class='form-control' 
                                            placeholder="ชื่อวิทยาศาสตร์" required="" oninput="setCustomValidity('')">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class='row clearfix'>
                            ...
                            <div class='col-lg-8 col-md-8 col-sm-9 col-xs-6'>
                                <div class='form-group'>
                                    <div class='form-line'>
                                        <textarea type="text" rows="2" class="form-control mb-2" name='charactor_insert' 
                                            id="charactor_insert" placeholder="ลักษณะ" required="" oninput="setCustomValidity('')"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class='row clearfix'>
                            ...
                            <div class='col-lg-8 col-md-8 col-sm-9 col-xs-6'>
                                <div class='form-group'>
                                    <div class='form-line'>
                                        <textarea type="text" rows="2" class="form-control mb-2" name='danger_insert' 
                                            id="danger_insert" placeholder="อันตราย" required="" oninput="setCustomValidity('')"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
