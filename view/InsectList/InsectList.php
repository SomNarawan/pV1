...
<div class="container">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <span style="float:right;">
                                ...
                                <span> > </span>
                                <a class="link-path link-active" href="#" style="color:<?=$color?>;">รายชื่อแมลง</a>
                            </span>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        ...
        <?php   
            creatCard( "card-color-one", "จำนวนชนิดแมลง", getCountInsect()." ชนิด", "" ); 
        ?>
    ...
    <div class="card shadow mb-4" id="card-pest">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold" style="color:<?=$color?>;">รายละเอียดแมลงศัตรูพืช</h6>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 " style="text-align: center;">
                        ...
                        <h6 class="m-0 font-weight-bold" style="color:<?=$color?>;">ชื่อ : <?php echo $INFO["Alias"]; ?></h6>
                        <h6 class="m-0 font-weight-bold" style="color:<?=$color?>;">ชื่อทางการ : <?php echo $INFO["Name"]; ?> </h6>
                    </div>

                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <h6 class="m-0 font-weight-bold" style="color:<?=$color?>;">ลักษณะทั่วไป</h6>
                        <span class="more">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <h6 class="m-0 font-weight-bold" style="color:<?=$color?>;">อันตรายของแมลง</h6>
                        <span class="more">
                            <?php echo $row["Danger"]; ?>
                        </span>
                        <br>
