                ...
                <tr>
                    ...
                    <td style="text-align:center;">
                        ...
                        <button type="button" class="btn btn-warning btn-sm btn_edit tt" 
                            did="<?php echo $ALLDEPARTMENT[$i]["DID"]; ?>" 
                            data-toggle="tooltip" title="แก้ไขข้อมูล"
                            department= "<?php echo $ALLDEPARTMENT[$i]["Department"];?>" 
                            alias="<?php echo $ALLDEPARTMENT[$i]["Alias"];?>" 
                            note = "<?php echo $ALLDEPARTMENT[$i]["Note"];?>">
                            <i class="fas fa-edit"></i></button>
                        <button type="button" class="btn btn-danger btn-sm tt" data-toggle="tooltip" title="ลบ"
                        onclick="delfunction('<?php echo $ALLDEPARTMENT[$i]["Department"]; ?>','<?php echo $ALLDEPARTMENT[$i]["DID"]; ?>',
