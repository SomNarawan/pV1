<?php 
    ...
    $HAVESTYEAR = getHarvestYearID($farmID,$currentYear);
...
<div class="container">
                        ...
                        <div class="col-12">
                            ...
                            <span style="float:right;">
                                ...
                                <a class="link-path link-active" href="#"
                                    style="color:#006633;">รายละเอียดผลผลิตสวนปาล์มน้ำมัน</a>
                            </span>
                        </div>
                    </div>
                </div>
    ...
    <div class="row mt-4">
        <?php   
            ...
            creatCard( "card-color-three",   "พื้นที่ทั้งหมด", getAreaRaiByFMID($farmID)." ไร่ ".getAreaNgan($farmID)." งาน ".getAreaWa($farmID)." วา", "format_size" ); 
        ?>
                                    ...
                                    <div class="col-xl-6 col-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <span>ผลผลิตทั้งหมด : <span id="sumweight"></span>
                                                            กิโลกรัม</span>
                                                    </div>
                                                </div>
                                                <div class="row">
                                        ...
                                        <div class="card">
                                            <div class="card-header card-bg">
                                                <div>
                                                    ...
                                                    <button type="button" id="btn_add_product" style="float:right;"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="table-responsive">
                                                    <table
                                                        class="table table-bordered table-striped table-hover table-data"
                                                        width="100%">
                                                        <thead>
                                                            <tr>
                                                                <th>ชื่อแปลง</th>
    ...
    <div class="modal fade" id="addProductModal" tabindex="-1" role="dialog">
        <form method="post" id="formAdd" name="formAdd" action="manage.php" < div class="modal-dialog modal-lg"
            role="document">
                ...
                <div class="modal-body" id="addModalBody">
                    <div class="row mb-4">
                        ...
                        <div class="col-xl-9 col-12">
                            <select id="sub" name="SubFarmID" class="form-control" required=""
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-xl-9 col-12">
                            <input type="number" name="UnitPrice" class="form-control" id="UnitPrice" required=""
                                oninput="setCustomValidity('')">
                            <input type="text" hidden class="form-control" name="request" id="request" value="insert">
                            <input type="text" hidden class="form-control" name="AddFarmID" id="FarmID"
                                value="<?php echo $farmID; ?>">
                        </div>
                    </div>
                    <!--<div class="row mb-4">
                    <div class="col-xl-3 col-12 text-right">
