            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <div class="dropdown no-arrow" align="right">
                    ...
                    <button type="button" class="btn btn-warning btn-sm btn_edit" 
                        pid="<?=$WEED['info'][1]["PID"]; ?>" 
                        name="<?=$WEED['info'][1]["Name"]; ?>" 
                        alias="<?=$WEED['info'][1]["Alias"]; ?>" 
                        charstyle="<?=$WEED['info'][1]["Charactor"]; ?>" 
                        dangerstyle="<?=$WEED['info'][1]["Danger"]; ?>" 
                        data-icon="<?=$WEED['info'][1]["Icon"]; ?>" 
                        numPicChar="<?=$WEED['info'][1]["NumPicChar"]; ?>" 
                        numPicDanger="<?=$WEED['info'][1]["NumPicDanger"]; ?>">
                        <i class="fas fa-edit"></i></button>

                    <button type="button" class="btn btn-danger btn-sm" 
                    onclick="delfunction('<?=$WEED['info'][1]["PID"]; ?>' , '<?=$WEED['info'][1]["Alias"]; ?>')">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 " style="text-align: center;">
                            <div style="text-align: center;">
                                <img src='<?php echo "../../icon/pest/".$WEED['info'][1]["PID"]."/".$WEED['info'][1]["Icon"]; ?>'
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel" id="silder">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        ...
                                        src='<?php echo "../../picture/Pest/weed/style/" .$WEED['info'][1]["PID"]."/".$WEED['info'][1]["Icon"]; ?>' 
                                        style="height:200px;">
                                    ...
                                    <?php for ($style_index = 0; $style_index < $WEED['info'][1]["NumPicChar"]-1; $style_index++) { ?>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" 
                                            src='<?php echo "../../picture/Pest/weed/style/".$WEED['info'][1]["PID"]."/".$style_index."_".$WEED['info'][1]["Icon"]; ?> '
                                            style="height:200px;">
                                        </div>
                                    <?php } ?>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            ...
                            <div id="carouselExampleControls2" class="carousel slide" data-ride="carousel" id="silder">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" 
                                            src='<?php echo "../../picture/Pest/weed/danger/".$WEED['info'][1]["PID"]."/".$WEED['info'][1]["Icon"]; ?> '
                                            style="height:200px;">
                                    ...
                                    <?php for ($danger_index = 0; $danger_index <$WEED['info'][1]["NumPicDanger"]-1; $danger_index++) { ?>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" 
                                            src='<?php echo "../../picture/Pest/weed/danger/".$WEED['info'][1]["PID"]."/".$danger_index."_".$WEED['info'][1]["Icon"]; ?>' 
                                            style="height:200px;">
                                        </div>
                                    <?php } ?>
                                </div>
                        ...
                        <div class="card-body"<?php echo $cardStyle; ?>  >
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" 
                                    ...
                                    <img src=<?php echo $src = "../../icon/pest/".$WEED['data'][$i]["PID"]."/".$WEED['data'][$i]["Icon"]; ?> 
