...
// // if( isset($_POST['s_formalid']))  $idformal = rtrim($_POST['s_formalid']); else $idformal = "";
// // if( isset($_POST['s_province']))  $fpro     = $_POST['s_province']; else $fpro  = "";
// // if( isset($_POST['s_distrinct'])) $fdist    = $_POST['s_distrinct']; else $fdist = "";
