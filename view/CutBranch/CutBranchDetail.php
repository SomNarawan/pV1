                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="main">
                            ...
                            <div >
                                <div class="col-xl-8 col-12">
                                    <input type="hidden" id="p_farm" name="p_farm" />
                                </div>
                            </div>
                            <div class="row mb-4">
                                <div class="col-xl-3 col-12 text-right">
...
<script>
    ...
    let data;
    let dataSubFarm;
    let farmID = <?php echo $farm[1]['FMID'] ?>;
    ...
    function loadSubFarm(farmID) {
        ...
        xhttp.open("GET", "./loadSubFarm.php?farm=" + farmID, true);
        xhttp.send();
    }
    ...
    $("#btn-modal4").on('click', function() {
        ...
        $('#p_farm').val(farmID);
        loadSubFarm(farmID);
        $('#p_subfarm').val(-1).trigger('change').html("<option disabled selected>เลือกแปลง</option>");
    ...
    $(document).on('click', '.btn-edit', function() {
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                let text2 = "";
                for (i in dataSubFarm)
                    text2 += ` <option value="${dataSubFarm[i].FSID}">${dataSubFarm[i].Name}</option> `
                $("#p_subfarm").html(text2);
