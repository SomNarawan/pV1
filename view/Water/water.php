                ...
                for (i in dataRain) {
                    text += `<tr>
                            ...
                            <th style="text-align:center;">
                                <button id='${i}' data-toggle="tooltip" title="1!" data-placement="bottom" FID='${dataRain[i].FID}' SFID='${dataRain[i].SFID}' UID='${dataRain[i].UID}' DSFID=${dataRain[i].DSFID}'  type="button" class="btn btn-info btn-sm btn-detail">
